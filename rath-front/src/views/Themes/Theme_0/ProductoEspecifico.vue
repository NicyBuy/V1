...
<div class="main">
  <div class="contenido-principal">
    ...
    <div class="Tienda">
      De: <router-link to="#" class="Tienda__nombre">Nombre Tienda</router-link>
    </div>
    ...
    <div class="Contacto__vendedor">
      Contactar Vendedor
      <div class="cont__RS">
        <a href="" class="RS instagram">
